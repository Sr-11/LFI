...
def train_d(n, m_list, title='Default', learning_rate=5e-4, 
    ...
    x_in, H, x_out = 2, 50, 50 # number of neurons in the input layer, hidden layer, and output layer
    ...
    np.save('./data/LFI_CIFAR_'+title+str(n),Results) 
...
if __name__ == "__main__":
    ...
    if diffusion_data:
        ...
        def diffusion_cifar10(n):
            ...
            return Xs, Ys
    train_d(512, [50], title=title, learning_rate=5e-4, K=10, N=100, 
            N_epoch=100, print_every=20, batch_size=32, test_on_new_sample=True, 
